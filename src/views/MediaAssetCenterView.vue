...
<style scoped>
.media-center__workspace { --media-center-content-inset: 16px; border-color: var(--app-border, #d9e2ec); border-radius: 8px; }
.media-center__workspace :deep(.el-card__body) { padding: 0; }
.media-center__header { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 13px var(--media-center-content-inset); border-bottom: 1px solid var(--app-border, #e6edf3); background: var(--app-surface, #fff); }
...
.media-center__icon { display: inline-flex; flex: 0 0 auto; align-items: center; justify-content: center; width: 34px; height: 34px; border-radius: 8px; color: var(--app-blue, #1f668f); background: var(--app-surface-muted, #eef8ff); }
.media-center__title h1 { color: var(--app-text, #1f2933); font-size: 18px; font-weight: 700; line-height: 1.25; }
.media-center__title p { margin-top: 3px; color: var(--app-text-muted, #66788a); font-size: 12px; }
.media-center__tabs :deep(.el-tabs__header) { margin: 0; padding: 0 var(--media-center-content-inset); background: var(--app-surface, #fff); }
.media-center__tabs :deep(.el-tabs__nav-wrap::after) { height: 1px; background: var(--app-surface-muted, #e6edf3); }
.media-center__tabs :deep(.el-tabs__item) { height: 40px; color: var(--app-text, #52606d); font-size: 13px; font-weight: 600; }
.media-center__tabs :deep(.el-tabs__item.is-active) { color: var(--app-blue, #1f668f); }
.media-center__tabs :deep(.el-tabs__content) { padding: 14px var(--media-center-content-inset) 16px; background: var(--app-surface-muted, #f8fafc); }
