      ...
      >
        ...
        >
          <template #default="{ row }">
            ...
            />
            <TaskTableCell
              v-else-if="column.type && ['taskIdentity', 'taskPlatform', 'taskResult', 'taskTimeline'].includes(column.type)"
              :kind="column.type as 'taskIdentity' | 'taskPlatform' | 'taskResult' | 'taskTimeline'"
              :row="row"
              :column="column"
            />
            <ScriptTableCell
