...
.template-identity__icon { display: inline-flex; width: 34px; height: 34px; flex: 0 0 34px; align-items: center; justify-content: center; border: 1px solid var(--app-border, #d5e3ee); border-radius: 7px; color: var(--app-text-muted, #426f91); background: var(--app-surface-muted, #f1f7fb); }
...
.template-identity__content strong { overflow: hidden; color: var(--app-text, #243b53); font-size: 13px; text-overflow: ellipsis; white-space: nowrap; }
...
.template-config__execution span { display: inline-flex; min-width: 0; align-items: center; gap: 4px; overflow: hidden; padding: 2px 6px; border: 1px solid var(--app-border, #dbe6ee); border-radius: 4px; color: var(--app-text-muted, #587087); background: var(--app-surface-muted, #f8fafc); font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }
.template-config__environment span:first-child { border-color: var(--app-border, #cfe1f2); color: var(--app-blue, #24658f); background: var(--app-surface-muted, #f2f8fc); }
.template-config__execution span:first-child { border-color: var(--app-border, #d7e8dc); color: var(--app-green, #3e7c55); background: var(--app-surface-muted, #f3faf5); }
...
.template-timeline > svg { width: 14px; height: 14px; flex: 0 0 14px; color: var(--app-text-muted, #527a98); }
.template-timeline > span { display: flex; min-width: 0; flex-direction: column; gap: 2px; }
.template-timeline strong { color: var(--app-text, #40566c); font-size: 11px; font-weight: 700; white-space: nowrap; }
.template-timeline small { color: var(--app-text-muted, #8a9aab); font-size: 10px; }
</style>
