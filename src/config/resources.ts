...
export const resources: Record<string, ResourceConfig> = {
  ...
  mediaAssets: {
    ...
    columns: [
      ...
      { key: "source_url", label: "素材地址", minWidth: 320 },
      { key: "status", label: "状态", type: "status", align: "center" },
      { key: "updated_at", label: "更新时间", type: "datetime", minWidth: 170, align: "center" },
    ],
    filters: [
    ...
    updateFields: [
      ...
      { key: "source_url", label: "素材地址", span: 2, allowEmpty: true },
      { key: "storage_uri", label: "内部存储地址", span: 2, allowEmpty: true },
      { key: "mime_type", label: "MIME 类型", allowEmpty: true },
      { key: "file_size", label: "文件大小(Byte)", type: "number" },
      { key: "width", label: "宽度", type: "number" },
      { key: "height", label: "高度", type: "number" },
      { key: "tags", label: "标签", type: "tags", placeholder: "多个标签用逗号或换行分隔" },
