...
export const resources: Record<string, ResourceConfig> = {
  accounts: {
    ...
    columns: [
      ...
      { key: "login_username", label: "登录账号", minWidth: 145 },
      { key: "group_name", label: "所属分组", minWidth: 120 },
      { key: "password_secret_ref", label: "密码", minWidth: 120 },
      { key: "totp_secret_ref", label: "2FA", minWidth: 160 },
      { key: "business_platform", label: "平台", width: 92 },
      { key: "country", label: "国家", width: 78, align: "center" },
      { key: "login_status", label: "登录状态", type: "status", width: 100 },
      {
        key: "bound_slot_id",
        label: "设备",
        type: "relation",
      ...
      { key: "updated_at", label: "更新时间", type: "datetime", width: 160, align: "center" },
    ],
    filters: [
      {
