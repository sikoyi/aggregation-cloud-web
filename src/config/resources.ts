      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "select",
            options: [
              { label: "系统动态规则", value: "system" },
              { label: "高频（每 5 分钟）", value: "high_frequency" },
              { label: "低频（每 6 小时）", value: "low_frequency" },
          ...
          },
          {
            ...
            max: 1440,
            defaultValue: 30,
            disabledWhen: { key: "monitor_mode", value: ["system", "high_frequency", "low_frequency"] },
          },
        ],
      },
    ],
