    ...
    rowActions: [
      {
        ...
        method: "POST",
        icon: "link",
        path: (record) => `/api/slot-groups/${record.id}/slots`,
        fields: [
          {
            key: "slot_id",
            label: "设备",
      ...
      },
      {
        ...
        variant: "danger",
        path: (record, payload) =>
          `/api/slot-groups/${record.id}/slots/${payload?.slot_id}`,
        fields: [
          {
            key: "slot_id",
            label: "设备",
      ...
      },
      {
        ...
        method: "POST",
        icon: "power",
        path: (record) => `/api/slot-groups/${record.id}/enable`,
        variant: "success",
      },
      {
        key: "disable",
        ...
        method: "POST",
        icon: "powerOff",
        path: (record) => `/api/slot-groups/${record.id}/disable`,
        variant: "danger",
        confirm: "确认禁用该设备组？禁用后不能再调整成员。",
      },
    ],
  },
